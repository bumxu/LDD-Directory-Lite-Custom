...
<div class="directory-lite">
    ...
    <p><?php _e('Introduce tu usuario y contraseña o Regístrate.', 'ldd-directory-lite' ); ?></p>

    <ul class="nav nav-tabs bump-up-more" role="tablist">
        <li class="active"><a href="#login" role="tab" data-toggle="tab"><?php _e('Entrar', 'ldd-directory-lite'); ?></a></li>
        <li><a href="#register" role="tab" data-toggle="tab"><?php _e('Registrarme', 'ldd-directory-lite'); ?></a></li>
        <li><a href="#lost-password" role="tab" data-toggle="tab"><?php _e('Recuperar Contraseña', 'ldd-directory-lite'); ?></a></li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="login">
            ...
            <form method="post" action="<?php echo site_url('wp-login.php') ?>" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="user_login" class="col-sm-3 control-label"><?php _e('Usuario', 'ldd-directory-lite'); ?></label>
                    <div class="col-sm-6">
                        <input id="user_login" class="form-control" type="text" name="log">
                    </div>
                </div>
                <div class="form-group">
                    <label for="user_pass" class="col-sm-3 control-label"><?php _e('Contraseña', 'ldd-directory-lite'); ?></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <div class="checkbox">
                            <label>
                                <input id="rememberme" type="checkbox" name="rememberme" value="forever"> <?php _e('Recordarme', 'ldd-directory-lite'); ?>
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <button type="submit" class="btn btn-default"><?php _e('Entrar', 'ldd-directory-lite'); ?></button>
                    </div>
                </div>
            </form>
        ...
        <div class="tab-pane" id="register">
            ...
            <?php if (get_option('users_can_register')): ?>
                <form method="post" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="user_email" class="col-sm-3 control-label"><?php _e('Tu E-mail', 'ldd-directory-lite'); ?></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" class="btn btn-default"><?php _e('Registrarme', 'ldd-directory-lite'); ?></button>
                        </div>
                    </div>
                </form>
            <?php else: ?>
        ...
        <div class="tab-pane" id="lost-password">
            ...
            <form method="post" action="<?php echo site_url('wp-login.php?action=lostpassword', 'login_post') ?>" class="form-horizontal">
                ...
                <input type="hidden" name="user-cookie" value="1">
                <div class="form-group">
                    <label for="user_login" class="col-sm-3 control-label"><?php _e('Introduce tu E-mail', 'ldd-directory-lite'); ?></label>
                    <div class="col-sm-6">
                        <input id="user_login" class="form-control" type="text" name="user_login">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <button type="submit" class="btn btn-default"><?php _e('Recuperar', 'ldd-directory-lite'); ?></button>
                    </div>
                </div>
            </form>
